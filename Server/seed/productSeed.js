...
},
{
  ...
  "brand": "BY SHARLY",
  "category": "Home & Kitchen",
  "image": "https://images.pexels.com/photos/4195588/pexels-photo-4195588.jpeg?auto=compress&cs=tinysrgb&w=600",
  "originalPrice": 900,
  "discountPrice": 650,
  "points": 300,
  "tag": "New"
},
{
  ...
  "brand": "BY SHARLY",
  "category": "Lifestyle",
  "image": "https://images.pexels.com/photos/3735208/pexels-photo-3735208.jpeg?auto=compress&cs=tinysrgb&w=600",
  "originalPrice": 1000,
  "discountPrice": 750,
  "points": 400,
  "tag": "Popular"
...
{
  "id": 17,
  "name": "Portable Solar Power Charger",
  "brand": "BY SHARLY",
  "category": "Tech",
...
// mongoose.connect("mongodb://127.0.0.1:27017/SharlyDatabase")
const dns = require("dns")
dns.setServers(['8.8.8.8','1.1.1.1'])
mongoose.connect("mongodb+srv://areebamirza1408_db_user:areebamirza@cluster0.myspecc.mongodb.net/")
  .then(async () => {
